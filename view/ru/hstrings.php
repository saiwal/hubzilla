...
App::$strings["Dark style"] = "Тёмная тема";
App::$strings["Light style"] = "Светлая тема";
App::$strings["Common settings"] = "Общие настройки";
App::$strings["Default to dark mode"] = "Тёмная тема по умолчанию";
App::$strings["No"] = "Нет";
App::$strings["Yes"] = "Да";
App::$strings["Always use light icons for navbar"] = "Всегда использовать светлые пиктограммы на панели навигации";
App::$strings["Enable this option if you use a dark navbar color in light mode"] = "Включите эту настройку если вы используете тёмную панель навигации в светлой теме";
App::$strings["Narrow navbar"] = "Узкая панель навигации";
App::$strings["Navigation bar background color"] = "Панель навигации, цвет фона";
App::$strings["Dark navigation bar background color"] = "Цвет фона тёмной панели навигации";
App::$strings["Link color"] = "Цвет ссылок";
App::$strings["Dark link color"] = "Тёмный цвет ссылок";
App::$strings["Link hover color"] = "Цвет ссылки при наведении курсора";
App::$strings["Dark link hover color"] = "Тёмный цвет ссылок при наведении курсора";
App::$strings["Set the background color"] = "Цвет фона";
App::$strings["Set the dark background color"] = "Установить тёмный цвет фона";
App::$strings["Set the background image"] = "Фоновое изображение";
App::$strings["Set the dark background image"] = "Установить изображение для тёмного фона";
...
App::$strings["Your test account is about to expire."] = "Ваша тестовая учётная запись вскоре перестанет работать.";
...
App::$strings["Item deleted"] = "Элемент удалён";
App::$strings["Comment"] = "Комментарий";
...
App::$strings["%s shared an %s with you"] = "%s поделился с вами %s";
...
App::$strings["This channel has not added a profile description yet"] = "Для этого канала пока не добавлено описание";
...
App::$strings["No recent activities"] = "Нет недавних действий";
...
App::$strings["Channel activities"] = "Действия в канале";
...
App::$strings["Multifactor Verification"] = "Многофакторная проверка";
App::$strings["Please enter the verification key from your authenticator app"] = "Пожалуйста, введите проверочный код из вашего приложения аутентификации";
...
App::$strings["Poke or ping somebody"] = "";
App::$strings["Recipient"] = "Получатель";
App::$strings["Choose action"] = "Выберите действие";
...
App::$strings["Automatically adjust pause before starting next task"] = "Автоматически настраиваемая пауза перед запуском следующего обработчика";
...
App::$strings["Additional trusted directory server URLs"] = "Дополнительные адрес довереных серверов каталога";
App::$strings["Accept directory flags (spam, nsfw) from those servers. One per line like https://example.tld"] = "Применять флаги, установленные для каталога (spam, nsfw), для этих серверов. По одному в каждой строке https://example.tld";
...
App::$strings["Check to force all profiles on this site to be listed in the site directory"] = "Установите этот флажок, чтобы все профили на этом сайте отображались в каталоге сайта.";
App::$strings["Enable public stream"] = "Включить публичный поток";
App::$strings["Enable the public stream. Warning: this content is unmoderated"] = "Включение публичного потока. Внимание, содержимое не модерируется!";
App::$strings["Site only public stream"] = "Публичный поток только для сайта";
App::$strings["Restrict the public stream to content originating at this site"] = "Ограничить публичный поток содержимым созданном только на этом сайте";
App::$strings["Allow anybody on the internet to access the public streams"] = "Разрешить всем в интеренет доступ к публичному потоку";
App::$strings["Disable to require authentication before viewing"] = "Отключить требование аутентификации для просмотра";
...
App::$strings["Entry OK"] = "Запись проверена";
...
App::$strings["Homepage: "] = "Домашняя страница:";
App::$strings["Description:"] = "Описание:";
App::$strings["Unsafe"] = "Небезопасно";
...
App::$strings["Multi-Factor Authentication"] = "Многофакторная аутентификация";
...
App::$strings["Password is required"] = "Требуется пароль";
App::$strings["The provided password is not correct"] = "Вы ввели неправильный пароль";
App::$strings["Account Multi-Factor Authentication"] = "Многофактурная аутентификация для учётной записи";
App::$strings["This is your generated secret. It may be used in some cases if the QR image cannot be read. Please store it in a safe place."] = "Это сгенерированный вами секретный код. Он может быть использован в случаях, если QR-изображение не может быть прочитано. Пожалуйста, храните его в безопасном месте.";
App::$strings["Please enter the code from your authenticator app"] = "Пожалуйста, введите код из вашего приложения аутентификации";
App::$strings["You will only be able to enable MFA if the test passes"] = "Вы сможете включить многофакторную аутентификацию только в том случае, если тест пройдет успешно";
App::$strings["Congratulations, the provided code was correct"] = "Поздравляем, вы ввели правильный код!";
App::$strings["Incorrect code"] = "Неправильный код";
App::$strings["Enable Multi-Factor Authentication"] = "Включить многофакторную аутентификацию";
App::$strings["Logging in will require you to be in possession of your smartphone"] = "Для входа в систему необходимо иметь под рукой смартфон";
App::$strings["Your account password"] = "Пароль вашей учётной записи";
...
App::$strings["Accept all messages which mention you"] = "Принимать все сообщения, где вас упоминают";
App::$strings["This setting bypasses normal permissions"] = "Это настройка изменяет обычные разрешения";
