...
App::$strings["No"] = "No";
App::$strings["Yes"] = "Sí";
App::$strings["Always use light icons for navbar"] = "Utilizar siempre iconos claros para la barra de navegación";
App::$strings["Enable this option if you use a dark navbar color in light mode"] = "Active esta opción si utiliza un color oscuro para la barra de navegación en el modo claro.";
...
App::$strings["This channel has not added a profile description yet"] = "Este canal aún no ha añadido una descripción de perfil";
...
App::$strings["Enable public stream"] = "Habilitar el \"stream\" público";
App::$strings["Enable the public stream. Warning: this content is unmoderated"] = "Habilitar el \"stream\" público. Advertencia: este contenido no está moderado";
App::$strings["Site only public stream"] = "Solo contenido público en este sitio";
App::$strings["Restrict the public stream to content originating at this site"] = "Restringir el \"stream\" público a los contenidos originados en este sitio";
...
App::$strings["Account Multi-Factor Authentication"] = "Autenticación multifactorial de la cuenta";
App::$strings["This is your generated secret. It may be used in some cases if the QR image cannot be read. Please store it in a safe place."] = "Este es su secreto generado. Puede ser utilizado en algunos casos si la imagen QR no puede ser leída. Por favor, guárdelo en un lugar seguro.";
App::$strings["Please enter the code from your authenticator app"] = "Introduzca el código de su aplicación de autenticación";
App::$strings["You will only be able to enable MFA if the test passes"] = "Sólo podrá activar la autenticación multifactorial si pasa la prueba";
App::$strings["Congratulations, the provided code was correct"] = "Enhorabuena, el código proporcionado era correcto";
App::$strings["Incorrect code"] = "Código incorrecto";
